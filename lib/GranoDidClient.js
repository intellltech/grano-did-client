...
const QueryChangedPayload = require('./payload/QueryChangedPayload')
const QueryAttributePayload = require('./payload/QueryAttributePayload')
const QueryValidToPayload = require('./payload/QueryValidToPayload')
...
class GranoDidClient {
   ...
   * attribute.
   *
   * @param {import('./payload/QueryAttributePayload').QueryAttributePayloadInstanceParams} attributeParams
   */
  async attribute (attributeParams) {
    const queryAttributePayload = QueryAttributePayload.create(attributeParams)
   ...
   * validTo.
   *
   * @param {import('./payload/QueryValidToPayload').QueryValidToPayloadInstanceParams} validToParams
   */
  async validTo (validToParams) {
    const queryValidToPayload = QueryValidToPayload.create(validToParams)

    return this._query(queryValidToPayload.buildParams())
  }

  /**
   * changed.
   *
   * @param {import('./payload/QueryChangedPayload').QueryChangedPayloadInstanceParams} changedParams
   */
  async changed (changedParams) {
    const queryChangedPayload = QueryChangedPayload.create(changedParams)

    return this._query(queryChangedPayload.buildParams())
  }
